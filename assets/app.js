/* Mudkeep11 — monthly Rainbet wager leaderboard.
   ...
   creators/mudkeep11.json, which is also what writes them into
...
(() => {
  ...
  async function runSearch() {
    ...
    if (!match) {
      setResult(`No wagers found for "${query}" this cycle. Make sure you signed up with code MDKP and that the spelling matches exactly.`, 'miss');
      return;
    }
