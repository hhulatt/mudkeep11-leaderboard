# Mudkeep11 — Rainbet wager leaderboard

Live at **https://mudkeep11.com/**

A one-page static site showing a $250 monthly wager leaderboard for Rainbet
affiliate code **MDKP**. Generated from the Forge Partners leaderboard
...
| --- | --- |
| Affiliate code | `MDKP` |
| Referral link | https://rainbet.com?r=mdkp |
...
5. **Point the domain** at Netlify and wait for the TLS certificate. A new
   ...
   certificate is actually issued for `mudkeep11.com` before telling anyone the
   site is live.
...
`creators/mudkeep11.json` in the template repo. Edit that, re-run
`node new-creator.mjs mudkeep11`, and copy the regenerated files over. The cycle
